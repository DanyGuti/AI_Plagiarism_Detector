...
class Java20ParserVisitor(ParseTreeVisitor):
    ...
    def visitIdentifier(self, ctx:Java20Parser.IdentifierContext):
        return self.visitChildren(ctx)
    ...
    def visitContextualKeyword(self, ctx:Java20Parser.ContextualKeywordContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by Java20Parser#contextualKeywordMinusForTypeIdentifier.
    def visitContextualKeywordMinusForTypeIdentifier(self, ctx:Java20Parser.ContextualKeywordMinusForTypeIdentifierContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by Java20Parser#contextualKeywordMinusForUnqualifiedMethodIdentifier.
    def visitContextualKeywordMinusForUnqualifiedMethodIdentifier(self, ctx:Java20Parser.ContextualKeywordMinusForUnqualifiedMethodIdentifierContext):
        return self.visitChildren(ctx)
